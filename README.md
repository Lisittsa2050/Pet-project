...
| -- | -------------------- | ---------------------- |----------------------------|
| 02 | Online Retail| Провести когортный и RFM-анализ, чтобы понять ценность, получаемую от различных сегментов клиентов. Построение моделей временных рядов. | `Numpy` `Pandas` `Seaborn` `Matplotlib` |
