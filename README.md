...
| -- | -------------------- | ---------------------- |----------------------------|
| 02 | Online Retail| Исследовательский анализ данных. Ad-hoc исследование. Определение метрик продукта. Когортный анализ и RFM-сегментация пользователей. | `Numpy` `Pandas` `Seaborn` `Matplotlib` |
